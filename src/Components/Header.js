...
const Header = () => {
  ...
  return (
    <div className="p-3 grid grid-flow-col font-verela shadow-sm">
      ...
      <form
        className="flex col-span-11 sm:col-span-10 justify-center"
        onSubmit={(e) => e.preventDefault}
      >
        <div className="flex flex-col w-[70%] sm:w-3/5 relative">
          <input
            type="text"
        ...
        <Link to={"/search?q=" + searchQuery}>
          <button
            ...
            className="border border-gray-300 py-2 px-3 sm:px-6 rounded-r-full border-l-0 bg-gray-100 "
          >
